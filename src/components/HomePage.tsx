import TengoLogo from '../assets/cuanto-logo.png'
import HomeImage from '../assets/cuanto-home-image.png'
...
function HomePage() {
  ...
  return (
    <main className='w-full min-h-screen flex flex-col lg:grid-cols-home lg:grid'>
      <div className='relative max-h-screen flex flex-col justify-center bg-[#0D7F5D] p-8 pt-8 pb-20 lg:py-20 lg:pt-8 lg:px-12'>
        <div className='h-full lg:self-end my-auto grid grid-cols-1 gap-10 lg:gap-8 place-content-between'>
          ...
          <div className='self-end my-auto grid gap-8'>
            ...
            <a
              href='#contacto'
              className='w-44 bg-[#04D999] text-[#0D7F5D] text-lg text-center rounded-3xl font-bold font-body py-2 lg:py-3 hover:bg-white hover:text-[#04D999] cursor-pointer z-50 transition-colors duration-300'
            >
              Me interesa
            </a>
          </div>
        ...
        >
          <div className='w-full flex items-center justify-between'>
            <p className='w-max flex flex-col text-black font-semibold text-xl'>
              Menú
              <span className='w-full h-1 rounded-2xl bg-[#0D7F5D]'></span>
            </p>
            <div
          ...
          <ul className='w-full flex flex-col gap-8 justify-start font-bold text-black mt-10'>
            ...
            <li className='bg-[#04D999] text-center py-2 px-8 text-white rounded-3xl cursor-pointer transition-all duration-500'>
              Ingresar
            </li>
          </ul>
        </aside>
